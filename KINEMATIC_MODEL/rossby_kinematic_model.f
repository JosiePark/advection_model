     ...
     &   trim(home_dir) // 'TRAJ/KINEMATIC/traj_rossby_top.nc'
...
C ------- KINEMATIC MODEL PARAMETERS --------------
      ...
      if (regime .eq. 1) then
          ...
          if (layer .eq. 1) then
            ...
            factor = 7.66667 ! width scaling
            A = 358.39526 ! amplitude of wave
      ...
      elseif (regime .eq. 2) then
          ...
          if (layer .eq. 1) then
            ...
            factor = 6. ! width scaling
            A = 246.2309383 ! amplitude of wave
      ...
      !c = 1.
      if (regime .eq. 1) then
       y_centre = 305. ! centre in grid points
      else
       y_centre = 301.
      endif
      cnd = c*2*pi/ii
